...
@section('content')
    <div class="container-fluid">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <p>
                    (2/17 08:10) 転送量軽減のため、一覧表示をサムネイル化しました。配信者画面での表示には影響ありません。これまでアップロードされたスタンプも順次サムネイル化していきます。<br>
                    <strong style="text-decoration: underline">「重いアニメgif」をアップロードする時は時間がかかるので、反応が無い場合でも少し待ってみて下さい。</strong><br>
                    また、連続してアップロードしないようお願いします。（通常の画像や軽いアニメgifはこれまで通りでも大丈夫です）
                </p>
